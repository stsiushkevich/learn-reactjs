...
<lt:layout cssClass="page home-page-page">
    ...
    <p>
        ...
        из 10 разных сёл. Эту плачевную ситуацию лучше всего предусмотреть заранее и предпринять
        все меры по её недопущению!
    </p>
    ...
    <p>Далее согласно документации в файле <b>main.scss</b> подключим стили bootstrap:</p>
