...
<div class="page create-new-react-app">
	...
	<p>Привязка в конструкторе (ES2015)</p>
	...
	<p>Стрелочная функция  в методе render</p>
	
	<ce:code-example-5/>
	
	<app:alert title="Внимание!" type="warning">
		Использование стрелочной функции в render создает новую функцию каждый раз при отрисовке компонента,
