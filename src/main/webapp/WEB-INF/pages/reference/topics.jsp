...
<lt:layout cssClass="page topic-list">
  ...
  <ol class="topic-list__topics">
    ...
    <li class="topic-list__topic">
      <a class="topic-list__topic-nav-link" href=${uncontrolledСomponentsUrl}><b>4.4	ReactDOMServer</b></a>
    </li>
    <li class="topic-list__topic">
      <a class="topic-list__topic-nav-link" href=${optimazingPerformanceUrl}><b>4.5 DOM Elements</b></a>
    </li>
    <li class="topic-list__topic">
