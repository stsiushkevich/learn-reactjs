...
<lt:layout cssClass="page hello-world-example-page">
        ...
        <wg:p>
            <ul>
                ...
                <li><b>Массивы и фрагменты</b>. Позволяют вам вернуть несколько элементов из <code>render</code>.
                    Смотрите документацию по <b><a href="${fragmentsUrl}">фрагментам</a></b> для более подробной информации.</li>
    ...
    <rf:definition title="constructor()">
        ...
        <app:alert title="Внимание!" type="warning">
            ...
            <p>
                Изучите <b><a href="${derivedStateNecessityUrl}">данный раздел</a></b> о том, как избежать использования производного
    ...
    <rf:definition title="componentWillUpdate()">
        ...
        <app:alert title="Замечание." type="warning">
            <code>componentWillUpdate()</code> не будет вызываться, если <code>shouldComponentUpdate()</code> возвращает
            <code>false</code>.
        </app:alert>
    </rf:definition>
    ...
    <br/>
    <h3>4.2.2.1 Редко используемые методы жизненного цикла</h3>
    <br/>
