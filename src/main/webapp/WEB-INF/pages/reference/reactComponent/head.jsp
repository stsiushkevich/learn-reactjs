...
<title itemprop="name">React.Component</title>
<meta property="og:title" content="React.Component">
<meta property="og:description" content="Компоненты позволяют разделить пользовательский
...
<meta name="description" content="Компоненты позволяют разделить пользовательский
интерфейс на самостоятельные, многоразовые фрагменты и работать с каждой частью независимо.
React.Component предоставляется React-ом.">
