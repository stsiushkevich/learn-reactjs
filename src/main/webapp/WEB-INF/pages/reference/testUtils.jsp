...
<lt:layout cssClass="page hello-world-example-page">
	...
	<app:alert type="warning" title="Замечание.">
		...
		Если вы решили, что применение модульного тестирования с испольозованием Jest
	...
	<rf:definition title="Simulate">
		...
		<wg:p><b>Изменения значения текстового поля ввода и последующее нажание ENTER</b></wg:p>
