...
<title itemprop="name">SyntheticEvent</title>
<meta property="og:title" content="SyntheticEvent">
<meta property="og:description" content="Вашим обработчикам событий будут переданы экземпляры
