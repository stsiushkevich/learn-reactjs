...
<lt:layout cssClass="page instalation-page">
    ...
    <app:alert type="warning" title="Внимание!">
        <wg:p>
            ...
            для удобного процесса разработки, включая линт, тестирование, оптимизацию продакшен и
    ...
    <wg:p>Данные менеджеры скачивают необходимые пакеты из <wg:link href="${npmRegisterUrl}">реестра npm</wg:link>.</wg:p>
