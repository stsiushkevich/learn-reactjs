...
<lt:layout cssClass="page introduction-in-reactjs-page">
    ...
    <wg:p>
        Мы рассмотрим поподробнее забавный XML-подобный синтаксис чуть позже. Созданные нами компоненты описывают, каким образом
    ...
    <wg:p>
        ...
        описание и отрисовывает его на экране. Само описание, которое возвращает метод <code>render()</code>, представляет
        из себя обычный JavaScript-объект типа <b>React element</b>, который является очень легковесным. Позднее мы рассмотрим
    ...
    <wg:p>
        ...
        упрощает написание и чтение иерархий компонентов. Рассмотрим принцип его работы. Определим тег <code>&lt;div/&gt;</code>.
