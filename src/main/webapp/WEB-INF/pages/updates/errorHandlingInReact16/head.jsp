...
<meta name="description" content="Мы рады объявить о выпуске React v16.0! Среди изменений есть некоторые давние запросы
        возможностей, в том числе фрагменты, границы ошибок, порталы, поддержка пользовательских
        атрибутов DOM, улучшенная отрисовка на стороне сервера и уменьшенный размер файла.">
<meta property="og:url" content="https://learn-reactjs.ru/updates/error-handling-in-react-16">
