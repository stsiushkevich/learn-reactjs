...
<div class="page create-react-app-2.0">
    ...
    <p>
        ...
        продакшен и модульной кодовой базы. Начиная с самого первого релиза, цель
    ...
    <p><b>Когда вы запустите <code>npm start</code> в первый раз после апгрейда</b>, вы получите запрос о том,
    ...
    <p><b>Если после апгрейда <code>npm start</code> по-прежнему не работает</b>, ознакомьтесь с более подробными
    ...
    <p><b>Если вы ранее выгрузили (выполнили <code>eject</code>) приложение, но теперь хотите провести апгрейд</b>, одно из распространенных
        решений - найти коммиты, в которых вы выгрузили приложение (и любые последующие коммиты, изменяющие
        конфигурацию), отменить их, провести апгрейд и позже при необходимости снова выгрузить. Также возможно,
