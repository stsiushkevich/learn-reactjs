...
<lt:layout cssClass="page hello-world-example-page">
  <wg:head size="3"><b>3.3 Ссылки ref и DOM</b></wg:head>
  ...
  <br/>
  <wg:head size="4"><b>3.3.1 Когда использовать ссылки ref</b></wg:head>
  ...
  <br/>
  <wg:head size="4"><b>3.3.2 Не злоупотребляйте ссылками ref</b></wg:head>
  ...
  <br/>
  <wg:head size="4"><b>3.3.3 Добавление ссылки ref на DOM элемент</b></wg:head>
  ...
  <br/>
  <wg:head size="4"><b>3.3.4 Добавление ссылки ref на компонент</b></wg:head>
  ...
  <br/>
  <wg:head size="4"><b>3.3.5 Ссылки ref и функциональные компоненты</b></wg:head>
  ...
  <br/>
  <wg:head size="4"><b>3.3.6 Доступ к ссылкам ref из родительских компонентов</b></wg:head>
  ...
  <br/>
  <wg:head size="4"><b>3.3.7 Старый API: Строковые ссылки ref</b></wg:head>
  ...
  <br/>
  <wg:head size="4"><b>3.3.8 Предостережения</b></wg:head>
