...
<lt:layout cssClass="page error-boundaries-page">
  ...
  <br/>
  <h2>3.12.4 Где устанавливать границы ошибок</h2>
  ...
  <br/>
  <h2>3.12.5 Новое поведение для необрабатываемых ошибок</h2>
  ...
  <br/>
  <h2>3.12.6 Трассировка стэка компонентов</h2>
  ...
  <br/>
  <h2>3.12.7 Почему не try/catch?</h2>
  ...
  <h2>3.12.8 Как насчет обработчиков событий?</h2>
  ...
  <br/>
  <h2>3.12.9 Изменения наименований в сравнении с React 15</h2>
