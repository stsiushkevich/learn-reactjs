...
<lt:layout cssClass="page error-boundaries-page">
  ...
  <br/>
  <h2>3.13.2 Параметры componentDidCatch</h2>
  ...
  <wg:p>
    Проверьте <wg:link href="${demoUrl}">данный пример</wg:link> объявления и использования границы ошибки.
  </wg:p>

  <br/>
  <h2>3.13.4 Где устанавливать границы ошибок</h2>
  ...
  <br/>
  <h2>3.13.5 Новое поведение для необрабатываемых ошибок</h2>
  ...
  <br/>
  <h2>3.13.6 Трассировка стэка компонентов</h2>
  ...
  <br/>
  <h2>3.13.7 Почему не try/catch?</h2>
  ...
  <h2>3.13.8 Как насчет обработчиков событий?</h2>
  ...
  <br/>
  <h2>3.13.9 Изменения наименований в сравнении с React 15</h2>
