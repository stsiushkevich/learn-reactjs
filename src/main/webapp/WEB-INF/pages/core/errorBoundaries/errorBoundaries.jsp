...
<c:url var="demoUrl" value="https://codepen.io/gaearon/pen/wqvxGa?editors=0010"/>

<a name="pageStart"></a>
<lt:layout cssClass="black-line"/>
<lt:layout cssClass="page error-boundaries-page">
  <h1>3.13 Границы ошибок</h1>

  <wg:p><b>Доступны с 16 версии.</b></wg:p>

  <br/>

  <p class="introduction">Ранее ошибки JavaScript внутри компонентов, ломали внутреннее состояние
    ...
    как эти ошибки возникли.</p>

  <br/>
  <br/>
  <div class="gray-line"></div>
  <h2>3.13.1 Знакомство с границами ошибок</h2>
  ...
  <p>Компонент-класс становится границей ошибки, если он определяет один из (или оба)
    методов жизненного цикла: <code>static getDerivedStateFromError()</code> или
    <code>componentDidCatch (error, info)</code>. Используйте <code>static getDerivedStateFromError()</code> для
    отрисовки аварийного интерфейса после возникновения ошибки. Используйте
    <code>componentDidCatch (error, info)</code> для регистрации информации об ошибке.</p>
  ...
  <wg:p>Границы ошибок работают как блок <code>catch {}</code> JavaScript, только для компонентов.
    Лишь компоненты класса могут являться границами ошибок. На практике вы скорее всего
  ...
  <p>
    Ознакомьтесь с <a href="${demoUrl}">данным примером объявления и использования границы ошибок с React 16.<b></b></a>
  </p>

  <br/>
  <br/>
  <div class="gray-line"></div>
  <h2>3.13.3 Где устанавливать границы ошибок</h2>
  ...
  <br/>
  <div class="gray-line"></div>
  <h2>3.13.4 Новое поведение для необрабатываемых ошибок</h2>
  ...
  <br/>
  <div class="gray-line"></div>
  <h2>3.13.5 Трассировка стека компонентов</h2>
  ...
  <br/>
  <div class="gray-line"></div>
  <h2>3.13.6 Как насчёт try/catch?</h2>
  ...
  <h2>3.13.7 Как насчет обработчиков событий?</h2>

  <br/>

  <wg:p>Границы ошибок <b>не отлавливают</b> ошибки внутри обработчиков событий.</wg:p>
  ...
  <br/>
  <div class="gray-line"></div>
  <h2>3.13.8 Изменения наименований в сравнении с React 15</h2>
