...
<lt:layout cssClass="page portals-page">
  ...
  <p class="introduction">Общим примером в React является компонент, возвращающий несколько элементов.
    Фрагменты позволяют группировать список потомков без добавления дополнительных узлов в DOM:</p>

  <br/>

  <ce:code-example-1/>

  <wg:p>Существует и <a href="#short-syntax"><b>короткий синтаксис</b></a>, но пока что его поддерживают
    не все популярные инструменты</wg:p>

  <br/>
  <br/>
  <div class="gray-line"></div>
  <h2>3.10.1 Мотивация</h2>
  <br/>
  ...
  <a name="short-syntax"></a>
  <br/>
  <h3>3.10.2.1 Короткий синтаксис</h3>
  ...
  <br/>
  <h3>3.10.2.2 Фрагменты с ключами</h3>
  ...
  <p>
    Вы можете попробовать новый JSX синтаксис фрагментов с
    помощью <a href="${frgJsxDemoUrl}"><b>данного CodePen</b></a>.
  </p>
