...
<lt:layout cssClass="page hello-world-example-page">
  <wg:head size="3"><b>3.11	Компоненты более высокого порядка (старшие компоненты)</b></wg:head>
  ...
  <br/>
  <wg:head size="3"><b>3.11.1	Использование старших компонентов для сквозной функциональности</b></wg:head>
  ...
  <br/>
  <wg:head size="3"><b>3.11.2	Не изменяйте оригинальный компонент. Используйте композицию</b></wg:head>
  ...
  <br/>
  <wg:head size="3"><b>3.11.3	Соглашение: передавайте несвязанные с контейнером свойства в упакованный компонент</b></wg:head>
  ...
  <br/>
  <wg:head size="3"><b>3.11.4	Соглашение: максимальная компонуемость</b></wg:head>
  ...
  <br/>
  <wg:head size="3"><b>3.11.5	Соглашение: оборачивайте отображаемое имя для простоты отладки</b></wg:head>
  ...
  <br/>
  <wg:head size="3"><b>3.11.6	Предостережения</b></wg:head>

  <wg:p>Старшие компоненты имеют несколько предостережений, которые не сразу очевидны, если вы
    новичок в React.</wg:p>

  <br/>
  <wg:head size="3"><b>3.11.6.1	Не используйте старшие компоненты внутри метода “render()”</b></wg:head>
  ...
  <br/>
  <wg:head size="3"><b>3.11.6.2	Статические методы должны быть скопированы</b></wg:head>
  ...
  <br/>
  <wg:head size="3"><b>3.11.6.3	Ссылки не передаются</b></wg:head>
