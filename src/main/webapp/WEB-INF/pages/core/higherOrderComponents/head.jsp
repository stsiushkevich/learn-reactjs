...
Higher-Order Components – сокращенно HOC), или старшие компоненты представляет собой усовершенствованный
подход в React для повторного использования логики компонентов.">
<meta property="og:url" content="https://www.learn-reactjs.ru/core/higher-order-components">
<meta name="keywords" CONTENT="Изучение React JS, Полное руководство по ReactJS, Компоненты более высокого порядка (старшие компоненты)">