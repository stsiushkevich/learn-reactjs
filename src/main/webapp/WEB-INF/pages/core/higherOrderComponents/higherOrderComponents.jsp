...
<lt:layout cssClass="page hello-world-example-page">
  ...
  <p class="introduction">
    Компонент более высокого порядка (в документации <b>Higher-Order Components</b> – сокращенно <b>HOC</b>) - это
    продвинутая техника в React для повторного
    использования логики компонента. По существу, HOC не являются частью React API.
  ...
  <wg:p>HOC являются общими для сторонних библиотек React, таких как Redux
    <code>connect</code> и <code>createFragmentContainer</code> Relay.</wg:p>
  ...
  <h2>3.15.1	Использование старших компонентов для сквозной функциональности</h2>

  <br/>

  <app:alert type="warning" title="Внимание!">
    Ранее рекомендовалось использовать миксины для сквозной функциональности.
  ...
  <wg:p>Например, предположим, что у вас есть компонент <code>NotificationList</code>, который
  ...
  <wg:p>
    <ul>
      <li><p>Сразу после монтирования добавляется слушатель изменений в <code>NotificationDataStore</code>.</p></li>
      <li><p>Внутри слушателя <code>setState</code> вызывается каждый раз, когда изменяется источник данных.</p></li>
      <li><p>При демонтаже слушатель изменений удаляется.</p></li>
    </ul>
  </wg:p>
  ...
  <br/>
  <div class="gray-line"></div>
  <h2>3.15.2	Не изменяйте оригинальный компонент. Используйте композицию</h2>
  ...
  <br/>
  <div class="gray-line"></div>
  <h2>3.15.3	Соглашение: передавайте несвязанные с контейнером свойства в упакованный компонент</h2>
  ...
  <br/>
  <div class="gray-line"></div>
  <h2>3.15.4	Соглашение: максимальная компонуемость</h2>
  ...
  <wg:p>(Эта же особенность также позволяет использовать <code>connect</code> и другие старшие компоненты
  ...
  <wg:p>Функция-утилита <code>compose</code> предоставляется многими сторонними библиотеками,
    включая <b>lodash</b> (как <a href="https://lodash.com/docs/#flowRight"><b>lodash.flowRight</b></a>),
    <a href="http://redux.js.org/docs/api/compose.html"><b>Redux</b></a> и
    <a href="http://ramdajs.com/docs/#compose"><b>Ramda</b></a>.</wg:p>

  <br/>
  <a name="3.15.5"></a>
  <br/>
  <div class="gray-line"></div>
  <h2>3.15.5 Соглашение: оборачивайте отображаемое имя для простоты отладки</h2>
  ...
  <br/>
  <h3>3.15.6.1	Не используйте старшие компоненты внутри метода “render()”</h3>
  ...
  <br/>
  <h3>3.15.6.2	Статические методы должны быть скопированы</h3>
  ...
  <br/>
  <h3>3.15.6.3	Ссылки не передаются</h3>
  ...
  <wg:p>Не смотря на то, что соглашением для компонентов более высокого порядка является
    ...
    он обрабатывается React-ом специальным образом. Если вы добавите <code>ref</code> в элемент,
