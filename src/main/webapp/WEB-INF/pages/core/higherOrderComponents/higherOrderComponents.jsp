...
<lt:layout cssClass="page hello-world-example-page">
  ...
  <wg:p>Компонент более высокого порядка (КБВП) (в документации <b>Higher-Order Components</b> – сокращенно <b>HOC</b>),
  ...
  <wg:p>
    <ul>
      <li>Сразу после монтирования добавляется слушатель изменений в <code>NotificationDataStore</code>.</li>
