...
<lt:layout cssClass="page hello-world-example-page">
  ...
  <br/>
  <h2>3.14.1	Использование старших компонентов для сквозной функциональности</h2>
  ...
  <br/>
  <h2>3.14.2	Не изменяйте оригинальный компонент. Используйте композицию</h2>
  ...
  <br/>
  <h2>3.14.3	Соглашение: передавайте несвязанные с контейнером свойства в упакованный компонент</h2>
  ...
  <br/>
  <h2>3.14.4	Соглашение: максимальная компонуемость</h2>
  ...
  <br/>
  <a name="3.14.5"></a>
  <h2>3.14.5 Соглашение: оборачивайте отображаемое имя для простоты отладки</h2>
  ...
  <br/>
  <h3>3.14.6.2	Статические методы должны быть скопированы</h3>
  ...
  <br/>
  <h3>3.14.6.3	Ссылки не передаются</h3>
