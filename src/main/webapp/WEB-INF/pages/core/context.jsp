...
<lt:layout cssClass="page hello-world-example-page">
  <wg:head size="3"><b>3.9 Контекст</b></wg:head>
  ...
  <br/>
  <wg:head size="3"><b>3.9.1 Почему не стоит использовать контекст</b></wg:head>
  ...
  <br/>
  <wg:head size="3"><b>3.9.2 Как использовать контекст</b></wg:head>
  ...
  <br/>
  <wg:head size="3"><b>3.9.3 Коммуникация между родителем и потомком</b></wg:head>
  ...
  <br/>
  <wg:head size="3"><b>3.9.4 Ссылка на контекст в методах жизненного цикла</b></wg:head>
  ...
  <br/>
  <wg:head size="3"><b>3.9.5 Ссылка на контекст в функциональных
    компонентах, не имеющих состояния</b></wg:head>
  ...
  <br/>
  <wg:head size="3"><b>3.9.6 Обновление контекста</b></wg:head>
