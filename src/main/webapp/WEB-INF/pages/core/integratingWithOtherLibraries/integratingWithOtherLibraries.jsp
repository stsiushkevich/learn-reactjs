...
<lt:layout cssClass="page hello-world-example-page">
  <h1>3.16	Интеграция со сторонними библиотеками</h1>
  ...
  <br/>
  <h2>3.16.1	Интеграция с плагинами манипуляции DOM</h2>
  ...
  <br/>
  <h2>3.16.1.1	Как подойти к проблеме</h2>
  ...
  <br/>
  <h2>3.16.1.2	Интеграция с JQuery UI Dialog плагином</h2>
  ...
  <br/>
  <h2>3.16.2	Интеграция с другими библиотеками</h2>
  ...
  <br/>
  <h3>3.16.2.1	Замена отрисовки, основанной на строках, на React</h3>
