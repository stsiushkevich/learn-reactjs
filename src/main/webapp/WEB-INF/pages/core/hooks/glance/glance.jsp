...
<div class="page hooks-glance-page">
    ...
    <%--<c:url var="usingStateHookUrl" value="using-state-hook"/>--%>
    <c:url var="usingStateHookUrl" value="https://reactjs.org/docs/hooks-state.html"/>
    
    <app:alert title="Детальное объяснение" type="warning">
        Вы можете узнать больше о хуке состояния в разделе
        <b><a href="${usingStateHookUrl}">Использование хука состояния</a></b>.
    </app:alert>
    ...
    <p>
        ...
        начиная с <b><a href="${usingStateHookUrl}">Использование хука состояния</a></b>.
    </p>
