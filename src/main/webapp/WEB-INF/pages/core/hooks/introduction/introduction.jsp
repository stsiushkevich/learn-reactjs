...
<div class="page create-new-react-app">
    ...
    <br/>
    <div class="gray-line"></div>
    <h2>3.12.2 Критические изменения отсутствуют</h2>
    <br/>
    ...
    <br/>
    <h3>3.12.3.1 Тяжело повторно использовать логику состояний между компонентами</h3>
    <br/>
    ...
    <br/>
    <h3>3.12.3.2 Сложные компоненты становятся тяжелыми для понимания</h3>
    <br/>
    ...
    <br/>
    <h3>3.12.3.3 Классы путают как людей, так и машины</h3>
    <br/>
