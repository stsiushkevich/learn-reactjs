...
<title itemprop="name">Представляем хуки React</title>
<meta property="og:title" content="Представляем хуки React">
...
<meta name="description" content="Хуки - это новая функция, которая позволяет вам использовать состояние и другие
        функции React без написания класса. В настоящее время они доступны в React v16.8.0-alpha.0.">
<meta property="og:url" content="https://learn-reactjs.ru/core/hooks/introduction">
<meta name="keywords" CONTENT="React, Хуки, Хуки в React, Хуки React">