...
<lt:layout cssClass="page hello-world-example-page">
  <wg:head size="3"><b>3.5 Оптимизация производительности</b></wg:head>
  ...
  <br/>
  <wg:head size="4"><b>3.5.1 Использование сборки Production</b></wg:head>
  ...
  <br/>
  <wg:head size="4"><b>3.5.2 Создание приложения React</b></wg:head>
  ...
  <br/>
  <wg:head size="4"><b>3.5.3 Однофайловые сборки</b></wg:head>
  ...
  <br/>
  <wg:head size="4"><b>3.5.4 Бранч (Brunch)</b></wg:head>
  ...
  <br/>
  <wg:head size="4"><b>3.5.5 Browserify</b></wg:head>
  ...
  <br/>
  <wg:head size="4"><b>3.5.6 Rollup</b></wg:head>
  ...
  <br/>
  <wg:head size="4"><b>3.5.7 webpack</b></wg:head>
  ...
  <br/>
  <wg:head size="4"><b>3.5.8 Профилирование компонентов с помощью вкладки
    «Производительность Chrome»</b></wg:head>
  ...
  <br/>
  <wg:head size="4"><b>3.5.9 Избежание согласования</b></wg:head>
  ...
  <br/>
  <wg:head size="4"><b>3.5.10	shouldComponentUpdate в действии</b></wg:head>
  ...
  <br/>
  <wg:head size="4"><b>3.5.11	Примеры</b></wg:head>
  ...
  <br/>
  <wg:head size="4"><b>3.5.12	Мощь неизменяющихся данных</b></wg:head>
  ...
  <br/>
  <wg:head size="4"><b>3.5.13	Использование неизменяемых структур данных</b></wg:head>
