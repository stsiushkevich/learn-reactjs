...
<title itemprop="name">Формы</title>
<meta property="og:title" content="Формы">
<meta property="og:description" content="Работа элементов HTML форм в React немного
...
<meta name="description" content="Работа элементов HTML форм в React немного
 отличается от работы других DOM-элементов, потому что элементы форм по своей
 природе обладают некоторым внутренним состоянием.">
