...
<lt:layout cssClass="page components-and-props-page">
    ...
    <br/>
    <h2>2.5.1 Функциональные компоненты и компоненты-классы</h2>
    ...
    <lt:layout cssClass="alert alert-danger">
        <b>Предостережение! Всегда именуйте свои компоненты с большой буквы.</b>
        <br/>
    ...
    <wg:p>Как правило, новые React приложения имеют единственный <code>App</code> компонент на самом верху иерархии.
        ...
        иерархии отображения.</wg:p>

    <lt:layout cssClass="alert alert-danger">
        <b>Предостережение!</b> Компоненты должны возвращать единственный корневой элемент. Вот почему в
