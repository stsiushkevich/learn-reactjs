...
<lt:layout cssClass="page components-and-props-page">
    ...
    <wg:p><wg:link href="http://codepen.io/gaearon/pen/YGYmEG?editors=0010">Попробовать в CodePen.</wg:link></wg:p>
    ...
    <wg:p><wg:link href="http://codepen.io/gaearon/pen/KgQKPr?editors=0010">Попробовать в CodePen.</wg:link></wg:p>
    ...
    <wg:p><wg:link href="http://codepen.io/gaearon/pen/VKQwEo?editors=0010">Попробовать в CodePen.</wg:link></wg:p>
    ...
    <wg:p>Данный компонент довольно сложно поддаётся именению из-за его вложенности. Также тяжело
    ...
    <wg:link href="http://codepen.io/gaearon/pen/rrJNJY?editors=0010">Попробовать в CodePen.</wg:link>
