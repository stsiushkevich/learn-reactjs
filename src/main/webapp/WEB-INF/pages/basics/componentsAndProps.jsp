...
<lt:layout cssClass="page hello-world-example-page">
    <wg:head size="3"><b>2.5 Компоненты и свойства</b></wg:head>
    ...
    <br/>
    <wg:head size="4"><b>2.5.1 Функциональные компоненты и компоненты-классы</b></wg:head>
    ...
    <br/>
    <wg:head size="4"><b>2.5.2 Отрисовка компонентов</b></wg:head>
    ...
    <br/>
    <wg:head size="4"><b>2.5.3 Композиция компонентов</b></wg:head>
    ...
    <br/>
    <wg:head size="4"><b><a name="extracting-components" class="anchor">2.5.4 Извлечение компонентов</a></b></wg:head>
    ...
    <br/>
    <wg:head size="4"><b>2.5.4 Свойства props – только для чтения</b></wg:head>
