...
<lt:layout cssClass="page hello-world-example-page">
	...
	<wg:p>Отрисовка по условию в React работает тем же образом, как и условия в JavaScript. Используйте операторы JavaScript,
	...
	<wg:p>В то время как объявление переменной и использование оператора <code>if</code> – хороший способ
		отрисовывать компонент по условию, иногда вы можете захотеть использовать более короткий синтаксис.
	...
	<wg:p>Вы можете встраивать любые выражения в JSX, оборачивая их в фигурные скобки. Это включает
		в себя и логический оператор <code>&&</code> JavaScript. Это может быть удобно для добавления
