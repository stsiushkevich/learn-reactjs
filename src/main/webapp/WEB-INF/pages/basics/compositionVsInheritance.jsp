...
<lt:layout cssClass="page hello-world-example-page">
	<wg:head size="3"><b>2.12	Композиция вместо наследования</b></wg:head>
	...
	<br/>
	<wg:head size="4"><b>2.12.1	Вмещаемость</b></wg:head>
	...
	<br/>
	<wg:head size="4"><b>2.12.2	Специализация</b></wg:head>
	...
	<br/>
	<wg:head size="4"><b>2.12.3	Что насчет наследования?</b></wg:head>
