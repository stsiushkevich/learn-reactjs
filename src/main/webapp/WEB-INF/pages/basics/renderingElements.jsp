...
<lt:layout cssClass="page hello-world-example-page">
    <wg:head size="3"><strong>Отрисовка Элементов</strong></wg:head>
    ...
    <br/>
    <wg:head size="4"><strong>Обновление отрисованного элемента</strong></wg:head>
    ...
    <br/>
    <wg:head size="4"><strong>React обновляет только то, что необходимо</strong></wg:head>
