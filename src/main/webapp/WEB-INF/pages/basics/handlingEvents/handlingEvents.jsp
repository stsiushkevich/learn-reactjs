...
<lt:layout cssClass="page hello-world-example-page">
	...
	<wg:p>
		<ul>
			...
			<li>С JSX вы передаете функцию как обработчик события, вместо строки</li>
		</ul>
	</wg:p>
	...
	<wg:p>Когда вы определяете компонент, используя ES6 класс, <b>общий паттерн таков: обработчик события
		должен быть методом класса.</b> К примеру, наш <code>Conditioner</code> компонент отрисовывает
	...
	<wg:p>Если вызов привязки вас раздражает, существует два сопоба, как вы можете это обойти. Если вы используете
