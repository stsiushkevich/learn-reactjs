...
<lt:layout cssClass="page hello-world-example-page">
	...
	<wg:p>Здесь <code>e</code> – это синтетическое событие. React определяет эти синтетические события в
		...
		совместимости. Посмотрите справочное руководство <wg:link href="${syntheticEventUrl}">SyntheticEvent</wg:link>, чтобы узнать об этом больше.</wg:p>
	...
	<wg:p>Вы должны быть внимательны со значением <code>this</code> в JSX-коллбэках. В JavaScript, методы класса не
		...
		её в <code>onClick</code>, то когда эта функция будет вызвана <code>this</code> будет <code>undefined</code>.</wg:p>
