...
<lt:layout cssClass="page hello-world-example-page">
	...
	<wg:p>Здесь <code>e</code> – это синтетическое событие. React определяет эти синтетические события в
		соответствии со спецификацией W3C. Поэтому вам нет необходимости волноваться о кросс-браузерной
		совместимости. Посмотрите справочное руководство <wg:link href="${syntheticEventUrl}">SyntheticEvent</wg:link>, чтобы узнать больше об этом.</wg:p>
	...
	<wg:p>Вы должны быть внимательны со значением <code>this</code> в JSX-коллбэках. В JavaScript методы класса не
		...
		его в <code>onClick</code>, <code>this</code> будет <code>undefined</code>, когда функция действительно будет вызвана.</wg:p>
	...
	<wg:p>В обоих случаях аргумент <code>e</code>, представляющий событие React, будет передан как
		второй аргумент после ID. С помощью стрелочной функции мы должны передавать его явно,
