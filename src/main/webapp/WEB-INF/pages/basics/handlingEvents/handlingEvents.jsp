...
<lt:layout cssClass="page handling-events-page">
	...
	<p><b>В случае использования инициализатора свойств</b>, можно использовать и такой вариант:</p>

	<ce:code-example-9/>

	<p>Данный вариант эквивалентен варианту с <code>bind</code> и имеет самую короткую и
		читабельную форму записи, но для его корректной работы вам нужно использовать Babel.</p>
</lt:layout>
