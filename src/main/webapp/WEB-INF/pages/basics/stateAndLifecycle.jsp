...
<lt:layout cssClass="page hello-world-example-page">
    <wg:head size="3"><b>2.6 Состояние и жизненный цикл</b></wg:head>
    ...
    <br/>
    <wg:head size="4"><b>2.6.1 Преобразование функций в классы</b></wg:head>
    ...
    <br/>
    <wg:head size="4"><b>2.6.2 Добавление локального состояния в класс</b></wg:head>
    ...
    <br/>
    <wg:head size="4"><b>2.6.3 Добавление методов жизненного цикла в класс</b></wg:head>
    ...
    <br/>
    <wg:head size="4"><b>2.6.4 Корректное обновление состояния</b></wg:head>

    <wg:p>Необходимо знать <b>три вещи</b> о <code>setState()</code>.</wg:p>

    <br/>
    <wg:head size="5"><b>2.6.4.1 Не модифицируйте состояние напрямую</b></wg:head>
    ...
    <br/>
    <wg:head size="5"><b>2.6.4.2 Обновления состояния могут быть асинхронными</b></wg:head>
    ...
    <br/>
    <wg:head size="5"><b>2.6.4.3 Обновления состояния мерджатся(merge)</b></wg:head>
    ...
    <br/>
    <wg:head size="4"><b>2.6.5 Нисходящий поток данных</b></wg:head>
