...
<lt:layout cssClass="page hello-world-example-page">
    ...
    <p>В документации эти методы называются «<b>lifecycle hooks</b>». Мы же для простоты
        будем называть их методами жизненного цикла (ЖЦ).</p>
    ...
    <p>О <code>setState()</code> нужно знать <b>три вещи</b>.</p>

    <br/>
    <h3>2.6.4.1 Не модифицируйте состояние напрямую</h3>

    <p>К примеру, этот компонент перерисовываться не будет:</p>
    ...
    <p>Чтобы это исправить, используйте следующую форму метода <code>setState()</code>, который
