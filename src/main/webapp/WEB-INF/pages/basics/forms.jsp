...
<lt:layout cssClass="page hello-world-example-page">
    <wg:head size="3"><b>2.10 Формы</b></wg:head>
    ...
    <br/>
    <wg:head size="4"><b>2.10.1 Контролируемые компоненты</b></wg:head>
    ...
    <br/>
    <wg:head size="4"><b>2.10.2	Тэг textarea</b></wg:head>
    ...
    <br/>
    <wg:head size="4"><b>2.10.3	Тэг select</b></wg:head>
    ...
    <br/>
    <wg:head size="4"><b>2.10.4	Обработка множества input</b></wg:head>
    ...
    <br/>
    <wg:head size="4"><b>2.10.5	Альтернативы контролируемым компонентам</b></wg:head>
    ...
    <wg:p>Иногда может быть утомительным использовать контролируемые компоненты, потому
        ...
        возможно, стоит рассмотреть <wg:link href="https://facebook.github.io/react/docs/uncontrolled-components.html">неконтролируемые компоненты</wg:link>,
