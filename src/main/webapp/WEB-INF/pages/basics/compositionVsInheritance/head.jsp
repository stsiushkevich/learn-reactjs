...
<title itemprop="name">Композиция вместо наследования</title>
<meta property="og:title" content="Композиция вместо наследования">
<meta property="og:description" content="React имеет мощную модель композиции, и мы рекомендуем
