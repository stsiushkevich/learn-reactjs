...
<lt:layout cssClass="page hello-world-example-page">
	<wg:head size="3"><b>2.11	Передача состояние вверх по иерархии</b></wg:head>
	...
	<br/>
	<wg:head size="4"><b>2.11.1	Передача состояния вверх по иерархии</b></wg:head>
	...
	<br/>
	<wg:head size="4"><b>2.11.2	Извлеченные уроки</b></wg:head>
