...
<lt:layout cssClass="page hello-world-example-page">
    ...
    <p class="introduction">Рассмотрим следующий код:</p>

    <ce:code-example-1/>

    <p>
        Этот симпатичный синтаксис в виде тегов не является ни строкой, ни HTML.
        Это синтаксический сахар JavaScript под названием <b>JSX</b>.
        Мы настоятельно рекомендуем использовать JSX вместе с React, так как он
        максимально ясно описывает внешний вид UI, одновременно включая в себя всю мощь JavaScript.
    </p>

    <p>
        JSX производит <b>React-элементы</b>. Мы будем исследовать их отрисовку в
        DOM-дерево в следующем разделе. Ниже вы познакомитесь с основами JSX,
        необходимыми для начала разработки на React.
    </p>
