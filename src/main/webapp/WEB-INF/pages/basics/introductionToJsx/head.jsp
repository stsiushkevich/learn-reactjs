...
<title itemprop="name">Знакомство с JSX</title>
<meta property="og:title" content="Знакомство с JSX">
<meta property="og:description" content="Этот симпатичный синтаксис в виде тегов не является ни строкой,
