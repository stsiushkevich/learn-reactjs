...
<lt:layout cssClass="page hello-world-example-page">
	<wg:head size="3"><b>2.8	Отрисовка по условию</b></wg:head>
	...
	<wg:p>Отрисовка по условию в React работает тем же образом, как и условия в JavaScript. Используйте JavaScript
		операторы, такие как <code>if</code> или <code>тернарный опрератор</code>, чтобы создавать элементы, представляющие текущее
	...
	<br/>
	<wg:head size="4"><b>2.8.1	Хранение элементов в переменных</b></wg:head>
	...
	<wg:p>В то время как объявление переменной и использование <code>if</code> оператора – хороший способ
		...
		Есть несколько способов встроить условия в JSX, рассматриваемые ниже.</wg:p>

	<br/>
	<wg:head size="4"><b>2.8.2	Встроенный If с логическим оператором &&</b></wg:head>
	...
	<br/>
	<wg:head size="4"><b>2.8.3	Встраивание If-else с помощью условного оператора</b></wg:head>
